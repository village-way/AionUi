...
const SiderCapabilitiesEntry: React.FC<SiderCapabilitiesEntryProps> = ({
  isMobile,
  isActive,
  collapsed,
  siderTooltipProps,
  ...
  if (collapsed) {
    return (
      <Tooltip {...siderTooltipProps} content={t('settings.capabilities')} position='right'>
        <div
          ...
          onClick={onClick}
          data-testid='sider-capabilities-entry'
        >
          <Lightning
            theme='outline'
            size='20'
