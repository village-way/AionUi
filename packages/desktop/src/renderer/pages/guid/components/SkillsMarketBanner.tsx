...
const SKILLS_MARKET_DETAILS_ZH = 'https://github.com/Ecloud/ZhanluWork/discussions';
const SKILLS_MARKET_DETAILS_EN = 'https://github.com/Ecloud/ZhanluWork/discussions';
