...
for f in ZhanluWork-1.0.0-win-x64.exe ZhanluWork-1.0.0-win-arm64.exe ZhanluWork-1.0.0-mac-x64.dmg ZhanluWork-1.0.0-mac-arm64.dmg ZhanluWork-1.0.0-linux-amd64.deb ZhanluWork-1.0.0-linux-arm64.deb; do
  if [ ! -f "$OUTPUT_DIR/$f" ]; then
